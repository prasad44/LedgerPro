...
export default function ApAgingPage() {
  ...
  const { data, isLoading, error } = useApAging(runDate) as { data: any; isLoading: boolean; error: any };
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold text-gray-800 flex items-center gap-2">
            <Building2 className="h-5 w-5" /> A/P Aging Summary
          </h1>
        </div>
            ...
            <Table>
              ...
              <TableBody>
                {data.entities.length === 0 && (
                  <TableRow><TableCell colSpan={7} className="text-center text-gray-400 py-8">No outstanding payables</TableCell></TableRow>
                )}
